...
> ```
>
> 当看到 _101_ 状态码时，说明 WebSocket 连接建立成功，之后的所有通信都会走**WebSocket数据帧（Frame）**
...
>
> - _一次握手_，长期通信：在连接建立后，只要不主动关闭连接或者出现网络异常，连接就会一直保持
> - _状态保持_：服务端和客户端可以在此连接上维持会话状态，非常适合需要持续交互/高频同步的场景
>
> # **双向通信**
>
> - 客户端可以发`send()`
